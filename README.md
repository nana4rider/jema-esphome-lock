...
JEM-A端子付きの電子錠を、Home Assistantで操作するためのドキュメントです。

Raspberry Pi Pico Wに下記の回路を取り付けることで動作します。
...
- [カーボン抵抗(炭素皮膜抵抗) 1/4W100Ω](https://akizukidenshi.com/catalog/g/g125101/) x1
